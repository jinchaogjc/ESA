...
_C.ACTIVE.LABOR = 'empty'
_C.ACTIVE.PIXELS = 40
# k-neighbor-radius
_C.ACTIVE.RADIUS_K = 1
# select mask numbers each images
_C.ACTIVE.MASKS = 40
# select super pixel numbers each images
_C.ACTIVE.SPIXELS = 40
# all super pixel numbers 
_C.ACTIVE.SPALLPIXELS = 1000
# super pixels compactness
_C.ACTIVE.COMPACTNESS = 15.0

_C.ACTIVE.ES_LABEL = 'SegmentationClassAug_es'
