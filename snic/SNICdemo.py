...
import sys
sys.path.append("./snic_python_interface")
...
def snicdemo():
    ...
    imgname = "bee.png"
    imgname = "snic_python_interface/2007_000032.jpg"
    ...
    savename = "bee_snic.png"
    savename = "snic_python_interface/2007_000032_snic.png"
    Image.fromarray(segimg).save(savename)
    return
