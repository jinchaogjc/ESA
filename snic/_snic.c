...
/* 17 */ _CFFI_OP(_CFFI_OP_POINTER, 14), // int *
...
_CFFI_UNUSED_FN
static void _cffi_checkfld_typedef_HEAP(HEAP *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  { NODE * *tmp = &p->nodes; (void)tmp; }
  (void)((p->len) | 0);  /* check that 'HEAP.len' is an integer */
  (void)((p->size) | 0);  /* check that 'HEAP.size' is an integer */
}
struct _cffi_align_typedef_HEAP { char x; HEAP y; };

_CFFI_UNUSED_FN
static void _cffi_checkfld_typedef_NODE(NODE *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->i) | 0);  /* check that 'NODE.i' is an integer */
  (void)((p->k) | 0);  /* check that 'NODE.k' is an integer */
  { double *tmp = &p->d; (void)tmp; }
}
struct _cffi_align_typedef_NODE { char x; NODE y; };

static void _cffi_d_FindSeeds(int x0, int x1, int x2, int * x3, int * x4, int * x5)
{
  FindSeeds(x0, x1, x2, x3, x4, x5);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_FindSeeds(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "FindSeeds", 6, 6, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5))
    return NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_SNIC_main(PyObject *self, PyObject *args)
{
  double * x0;
  int x1;
  int x2;
  ...
  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(17), arg8, (char **)&x8);
  if (datasize != 0) {
    x8 = ((size_t)datasize) <= 640 ? (int *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(17), arg8, (char **)&x8,
            datasize, &large_args_free) < 0)
      return NULL;
  }
...
#else
#  define _cffi_f_SNIC_main _cffi_d_SNIC_main
#endif

static void _cffi_d_pop(HEAP * x0, unsigned int * x1, unsigned int * x2, double * x3)
{
  pop(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_pop(PyObject *self, PyObject *args)
{
  HEAP * x0;
  unsigned int * x1;
  unsigned int * x2;
  ...
  if (!PyArg_UnpackTuple(args, "pop", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;

  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(1), arg0, (char **)&x0);
  if (datasize != 0) {
    x0 = ((size_t)datasize) <= 640 ? (HEAP *)alloca((size_t)datasize) : NULL;
...
#else
#  define _cffi_f_pop _cffi_d_pop
#endif

static void _cffi_d_push(HEAP * x0, unsigned int x1, unsigned int x2, double x3)
{
  push(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_push(PyObject *self, PyObject *args)
{
  HEAP * x0;
  unsigned int x1;
  unsigned int x2;
  ...
  if (!PyArg_UnpackTuple(args, "push", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_push _cffi_d_push
#endif

static void _cffi_d_rgbtolab(double * x0, double * x1, double * x2, double x3, double * x4, double * x5, double * x6)
{
  rgbtolab(x0, x1, x2, x3, x4, x5, x6);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_rgbtolab(PyObject *self, PyObject *args)
{
  double * x0;
  double * x1;
  double * x2;
  ...
  if (!PyArg_UnpackTuple(args, "rgbtolab", 7, 7, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6))
    return NULL;
...
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_runSNIC(PyObject *self, PyObject *args)
{
  double * * x0;
  int x1;
  int x2;
...
#else
#  define _cffi_f_runSNIC _cffi_d_runSNIC
#endif
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__snic(const void *p[])
{
...
PyInit__snic(void)
{
  return _cffi_init("_snic", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_snic(void)
{
  _cffi_init("_snic", 0x2601, &_cffi_type_context);
}
#endif
